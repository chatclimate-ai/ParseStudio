...
class TestOpenAIPDFParser:
    ...
    def test_init_default(self):
        with patch("parsestudio.parsers.openai_file_search_parser.OpenAI") as mock_openai:
    ...
    @patch.object(OpenAIFileSearchPDFParser, "_OpenAIFileSearchPDFParser__export_result")
